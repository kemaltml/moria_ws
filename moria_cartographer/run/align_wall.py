...
# Membership Function - turn
turn['fast_right'] = fuzz.trimf(turn.universe, [-0.2, -0.2, -0.05])
turn['right']      = fuzz.trimf(turn.universe, [-0.1, 0, 0])
turn['stop']       = fuzz.trimf(turn.universe, [-0.05, 0, 0.05])
turn['left']       = fuzz.trimf(turn.universe, [0, 0, 0.1])
turn['fast_left']  = fuzz.trimf(turn.universe, [0.05, 0.2, 0.2])
